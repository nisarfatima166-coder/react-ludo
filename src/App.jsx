export default function App (){
  return (
    ...
    <div>
      <h1 class="heading"><u>LUDO BOARD:</u></h1>
       <div class="game">
        <div class="house red">
            <div class="box">
        ...
        <div class="house blue" style="bottom: 0">
            <div class="box">
        ...
        <div class="cells green" style="top: 46.66%; right: 33.3%"></div>
        <div class="cells green" style="top: 46.66%;right:26.64%;"></div>
        <div class="cells green" style="top: 46.66%;right:19.98%;"></div>
        <div class="cells green" style="top: 46.66%;right:13.32%;"></div>
        <div class="cells green" style="top: 46.66%;right:6.66%;"></div>
        ...
        <div class="cells blue " style="bottom: 6.66%;left:46.66%;"></div>
        <div class="cells blue" style="bottom: 13.32%;left:46.66%;"></div>
        <div class="cells blue" style="bottom: 19.98%;left:46.66%;"></div>
        <div class="cells blue" style="bottom: 26.64%;left:46.66%;"></div>
        <div class="cells blue" style="bottom: 33.3%;left:46.66%;"></div>
        ...
        <div class="cells red" style="top: 46.66%;left: 33.3%"></div>
        <div class="cells red" style="top: 46.66%;left:26.64%;"></div>
        <div class="cells red" style="top: 46.66%;left:19.98%;"></div>
        <div class="cells red" style="top: 46.66%;left:13.32%;"></div>
        <div class="cells red" style="top: 46.66%;left:6.66%;"></div>
